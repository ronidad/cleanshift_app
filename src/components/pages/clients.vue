...
<br>
<button class="btn btn-success" @click="downloadPDF">Download all clients </button>
...
export default {
  ...
  methods: {
    downloadPDF(){
      ...
      var colt = ["Name","Phone", "Court", "Arrears"];
       
       var rowst = [];
       

        this.clients.forEach(client => {      
        var temp = [client.name,  client.phone, client.court, client.arrears, ];
        rowst.push(temp);
         }); 
